...
public record EnderecoViewDTO(
    ...
    public static EnderecoViewDTO fromEntity(Endereco endereco){
        Cidade enderecoCidade = endereco.getCidade();
        CidadeSimpleViewDTO cidadeView =  CidadeSimpleViewDTO.fromEntity(enderecoCidade);
        return new EnderecoViewDTO(endereco.getId(), endereco.getNomeDoLocal(), endereco.getNumero(), endereco.getCep(), endereco.getPontoReferencia(), endereco.getLogradouro(), cidadeView);
    }
}
